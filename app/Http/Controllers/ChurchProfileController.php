...
class ChurchProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pradmin.church_profile.churchProfile')->with('posts',$posts);
    ...
    {
return view('pradmin.church_profile.createProfile');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pradmin.church_profile.editprofile')->with('posts',$posts);
    }
