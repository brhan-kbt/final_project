...
class EducMaterialController extends Controller
{
    ...
    {
        $this->middleware('educadmin', ['except'=>['displayBooks','displayArticles']]);
    }
    
    public function displayBooks(){
        $books=Educ_Material::all()->where('type','book');
        
        return view('EducationAdmin.educ_material.educ_materials')->with('books',$books);
    }
    ...
    public function index()
    {
        ...
        return view('EducationAdmin.educ_material.index')->with('books',$books);
    }
    ...
    {
        return view('EducationAdmin.educ_material.upload');
    }
    ...
    public function show($id)
    {
        ...
        return view('EducationAdmin.educ_material.show')->with('books',$books);
    ...
    {
        $books=Educ_Material::find($id);
        return view('EducationAdmin.educ_material.update')->with('books',$books);
    }
