...
class MuseumRecordController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('event_museum_record_admin.musuem.musuem')->with('posts',$posts);
//    return "index";
    }
    ...
    public function create()
    {
        ...
        return view('event_museum_record_admin.musuem.post');
    }
    ...
    public function show($id)
    {
        ...
        return view('event_museum_record_admin.musuem.show')->with('posts',$posts);
    ...
    {
        $posts=MuseumRecord::find($id);
        return view('event_museum_record_admin.musuem.edit')->with('posts',$posts);
