...
class EventController extends Controller
{
    ...
    {
        return view('event_museum_record_admin.posts.post');
    }
    ...
    {
        $posts=Event::find($id);
        return view('event_museum_record_admin.posts.show')->with('posts',$posts);
    ...
    {
        $posts=Event::find($id);
        return view('event_museum_record_admin.posts.edit')->with('posts',$posts);
